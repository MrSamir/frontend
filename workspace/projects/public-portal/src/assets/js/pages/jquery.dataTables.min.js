...
(function (f) {
  ...
  q.defaults = {
    ...
    oLanguage: {
      ...
      sEmptyTable: "لايوجد بيانات حاليا",
      sInfo: "عرض الصفحة 1 من 1 - إجمالي السجلات 1",
      sInfoEmpty: "عرض الصفحة 1 من 1 - إجمالي السجلات 1",
      sInfoFiltered: "(filtered from _MAX_ total entries)",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
      sLengthMenu: "عرض  _MENU_ سجلات بالصفحة",
      sLoadingRecords: "Loading...",
      sProcessing: "Processing...",
      sSearch: "بحث برقم الطلب:",
      sSearchPlaceholder: "",
      sUrl: "",
      sZeroRecords: "لايوجد بيانات حاليا",
    },

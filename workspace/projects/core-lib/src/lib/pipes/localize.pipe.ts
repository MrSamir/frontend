...
export class LocalizePipe implements PipeTransform {
  ...
  transform(key: any): any {
    return this.localization.localizeWeb(key) || key;
  }
...
export class LocalizePipe implements PipeTransform, OnDestroy {
  ...
  constructor(private localization: LocalizationService, private _ref: ChangeDetectorRef) {
  }
  ...
  updateValue(key: string, interpolateParams?: Object, translations?: any): void {
    ...
    if (translations) {
      let res = this.localization.getParsedResult(translations, key, interpolateParams);
    ...
    this.localization.get(key, interpolateParams).subscribe(onTranslation);
  }
